...
TrajOptProbPtr TRAJOPT_API ConstructProblem(const Json::Value&, EnvironmentInterface::Ptr env);
...
public:
  ...
  EnvironmentInterface::Ptr GetEnv() { return m_rad->GetEnv(); }
 ...
 * \f}
 * 
 * Continuous-time penalty: same, except you consider swept-out shapes of robot links. Currently self-collisions are not included.
 */
